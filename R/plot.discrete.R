...
plot.discrete <- function(dist, stat = c(0,1), params, section = "lower", strict){
  ...
  if(section == "lower"){
    ...
    barplot(y, ylim = c(0, ymax), col=c(rep("goldenrod",i),rep("white",j)), main=graphmain, ylab="Probability")
    barplot(y, ylim = c(0, ymax), xlab = "Values", names.arg = x, col=c(rep("goldenrod",i),rep("white",j)), density=c(rep(3,i),rep(0,j)), add = TRUE)
    ...
    barplot(y, ylim = c(0, ymax), col=c(rep("white",i),rep("goldenrod",j),rep("white",k)), main=graphmain, ylab="Probability")
    barplot(y, ylim = c(0, ymax), xlab = "Values", names.arg = x, col=c(rep("white",i),rep("goldenrod",j), rep("white",k)), density=c(rep(0,i),rep(3,j),rep(0,k)), add = TRUE)
    ...
    barplot(y, ylim = c(0, ymax), col=c(rep("white",i),rep("goldenrod",j)), ylab = "Probability", main=graphmain)
    barplot(y, ylim = c(0, ymax), xlab = "Values", names.arg = x, col=c(rep("white",i),rep("goldenrod",j)), density=c(rep(0,i),rep(3,j)), add = TRUE)
  ...
  else if(section == "tails") #implemented in v4.0
  {
    ...
    #build graphs
    barplot(y, ylim = c(0, ymax), col=c(rep("goldenrod",i),rep("white",j),rep("goldenrod",k)), ylab = "Probability", main=graphmain )
    barplot(y, ylim = c(0, ymax), xlab = "Values", names.arg = x,
            col=c(rep("goldenrod",i),rep("white",j), rep("goldenrod",k)), density=c(rep(3,i),rep(0,j),rep(3,k)),
            add = TRUE)
