...
# Evaluates lower tail.
plotT(stat = -1, df = 15, section = "lower") 

# Evaluates bounded region.
plotT(stat = c(-2,2), df = 15, section = "bounded") 
...
# Evaluates lower tail.
plotF(stat = 1, df1 = 2, df2 = 4, section = "lower") 

# Evaluates bounded region.
plotF(stat = c(3,5), df1 = 2, df2 = 4, section = "bounded") 

# Evaluates upper tail.
plotF(stat = 1, df1 = 2, df2 = 4, section = "upper") 
